...
public enum MessageKeys {
    ...
    PUNISHMENT_WARN_INVALID_PRESET("", "", true),
    PUNISHMENT_WARN_PRESET("", "", true),
    PUNISHMENT_WARN_SUCCESSFULLY_WARNED("", "", true),
    PUNISHMENT_WARN_USAGE("", "", true),
    PUNISHMENT_UNWARN_INVALID_ID("", "", true),
    PUNISHMENT_UNWARN_SUCCESSFULLY_UNWARNED("", "", true),
    PUNISHMENT_UNWARN_USAGE("", "", true),
    PUNISHMENT_TEMPWARN_SUCCESSFULLY_WARNED("", "", true),
    PUNISHMENT_TEMPWARN_USAGE("", "", true),
    PUNISHMENT_EDITWARN_INVALID_ID("", "", true),
    PUNISHMENT_EDITWARN_REASON("", "", true),
    PUNISHMENT_EDITWARN_DURATION("", "", true),
    PUNISHMENT_EDITWARN_USAGE("", "", true),
    PUNISHMENT_WARNLOG_EMPTY("", "", true),
    PUNISHMENT_WARNLOG_HEADER("", "", true),
    PUNISHMENT_WARNLOG_ENTRY("", "", true),
    PUNISHMENT_WARNLOG_ACTIONS("", "", true),
    PUNISHMENT_WARNLOG_USAGE("", "", true),
    PUNISHMENT_WARNINGS_EMPTY("", "", true),
    PUNISHMENT_WARNINGS_HEADER("", "", true),
    PUNISHMENT_WARNINGS_ENTRY("", "", true),
    PUNISHMENT_WARNINGS_ACTIONS("", "", true),
    PUNISHMENT_WARNINGS_USAGE("", "", true),
